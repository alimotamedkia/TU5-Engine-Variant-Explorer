...
import ir.anishehparsi.tu5eve.destinations.AatPageDestination

@Composable
fun AecsUi(modifier: Modifier = Modifier, item: Models, navigator: DestinationsNavigator) {
    OutlinedCard(
        modifier = modifier
            .fillMaxWidth(),
        onClick = { navigator.navigate(AatPageDestination(item)) }
